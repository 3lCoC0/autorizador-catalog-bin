...
public record BinCreateRequest(
        ...
        String name,
        @NotNull
        @Pattern(regexp="DEBITO|CREDITO|PREPAGO",message="typeBin debe ser DEBITO|CREDITO|PREPAGO") String typeBin,
        @NotNull @Pattern(regexp="\\d{2}",message="typeAccount debe ser de 2 posiciones numericas") String typeAccount,
        @SafeText(allowNumbers = true, allowUnderscore = false, allowSpaces = true,
                message = "compensationCod solo permite letras, numeros (incluye tildes/ñ) y espacios; no se admite la palabra 'null' ni caracteres especiales")
        ...
        String description,
        @Pattern(regexp= "[YN]", message="usesBinExt debe ser 'Y' o 'N'") String usesBinExt,
        String createdBy,
